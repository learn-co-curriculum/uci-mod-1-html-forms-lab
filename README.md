...
- Build a functional HTML contact form

## Introduction

Businesses of all types and sizes want to provide multiple ways for their
...
* A checkbox with the text of your choosing
* A submit button
...
We are only focused on building out the front end side of this form right now.
When a form is submitted, it is up to the _backend_ of a website to decide how
to handle and store form data when submitted.
